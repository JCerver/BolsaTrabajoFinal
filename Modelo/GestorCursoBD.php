...
function addCurso($id_empresa,$cur_nombre,$cur_fechaInicio,$cur_fechaFinal,$cur_duracion,$cur_direccion,$cur_descripcion,$cur_tipo,$cur_costo,$cur_personas,$cur_empresa,$cur_categoria,$cur_horario){
    $query = "call insertarCurso('$id_empresa','$cur_nombre','$cur_fechaInicio','$cur_fechaFinal','$cur_duracion','$cur_direccion','$cur_descripcion','$cur_tipo','$cur_costo','$cur_personas','$cur_empresa','$cur_categoria','$cur_horario');";
