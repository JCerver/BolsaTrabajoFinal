...
$resultado = addVacante($id_empresa, $nombre, $puesto,$salario,$horario,$requisitos,$descripcion,$fecha);
...
$fecha=$_POST["txtFecha"];
        ...
        $rs = updateVacante($id_empresa, $nombre, $puesto,$salario,$horario,$requisitos,$descripcion,$fecha,$id);
