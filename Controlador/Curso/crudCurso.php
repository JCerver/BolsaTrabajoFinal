...
$resultado = addCurso($idE,$nombre,$fechaInicio,$fechaFinal,$duracion,$dir,$descripcion,$tipo,$costo,$orientado,$empresa,$categoria,$horario);
...
if ($resultado) {
	...
	if(isset($_POST['btnModificar'])){
        ...
        $rs = updateCurso($idE, $nombre, $empresa,$tipo,$fechaInicio,$fechaFinal,$dir,$duracion,$horario,$descripcion,$costo,$orientado,$categoria,$id);
