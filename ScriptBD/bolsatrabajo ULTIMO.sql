...
CREATE TABLE IF NOT EXISTS `tbl_candidato` (
  ...
  `can_nacimiento` date DEFAULT NULL COMMENT 'Fecha de nacimiento',
...
DROP PROCEDURE IF EXISTS insertarCurso;
 ...
 insert into tbl_curso(fk_id_empresa,cur_nombre,cur_fechaInicio,cur_fechaFinal,cur_duracion,cur_direccion,cur_descripcion,cur_tipo,cur_costo,cur_personas,cur_empresa,cur_categoria,cur_horario) values (fk_id_empresa,cur_nombre,cur_fechaInicio,cur_fechaFinal,cur_duracion,cur_direccion,cur_descripcion,cur_tipo,cur_costo,cur_personas,cur_empresa,cur_categoria,cur_horario);
 ...
 call getCursosPorCategoria('Ingeniería');
